...
namespace PhysicalMeasure
{
    ...
    public static class DimensionExponentsExtension
    {
        public static Boolean DimensionEquals(this SByte[] exponents1, SByte[] exponents2)
        {
            ...
            Debug.Assert(MaxNoOfBaseUnits <= Global.PhysicsNoOfBaseUnits + 1, "Too many base units:" + MaxNoOfBaseUnits.ToString() + ". No more than " + (Global.PhysicsNoOfBaseUnits + 1) + " expected.");
        ...
        public static Boolean IsDimensionless(this SByte[] exponents)
        {
            ...
            Debug.Assert(NoOfBaseUnits <= Global.PhysicsNoOfBaseUnits + 1, "Too many base units:" + NoOfBaseUnits.ToString() + ". No more than " + (Global.PhysicsNoOfBaseUnits + 1) + " expected.");
        ...
        public static SByte[] CombineExponentArrays(this SByte[] exponents1, SByte[] exponents2, CombineExponentsFunc cef)
        {
            ...
            Debug.Assert(NoOfBaseUnits1 <= Global.PhysicsNoOfBaseUnits + 1, "exponents1 has too many base units:" + NoOfBaseUnits1.ToString() + ". No more than " + (Global.PhysicsNoOfBaseUnits + 1) + " expected.");
            Debug.Assert(NoOfBaseUnits2 <= Global.PhysicsNoOfBaseUnits + 1, "exponents2 has too many base units:" + NoOfBaseUnits2.ToString() + ". No more than " + (Global.PhysicsNoOfBaseUnits + 1) + " expected.");
    ...
    public readonly struct UnitPrefixExponent : IUnitPrefixExponent
    {
        ...
        public UnitPrefixExponent(SByte somePrefixExponent)
            : this(somePrefixExponent, 10)
        {
        }

        public UnitPrefixExponent(SByte somePrefixExponent, UInt16 somePrefixBase = 10)
        {
            this.Exponent = somePrefixExponent;
            this.Base = somePrefixBase;
        }
    ...
    /***
    public readonly struct MetricUnitPrefixExponent : UnitPrefixExponent
    {
        public MetricUnitPrefixExponent(SByte somePrefixExponent)
            : base (somePrefixExponent, 10)
        {
        }

    }

    public readonly struct DataUnitPrefixExponent : IUnitPrefixExponent
    {
        public DataUnitPrefixExponent(SByte somePrefixExponent)
            : base(somePrefixExponent, 1024)
        {
            this.Exponent = somePrefixExponent;
        }
    ...
    ***/
    ...
    // public readonly class UnitPrefix : NamedItem, IUnitPrefix
    {
        ...
        public Char SecondPrefixChar { get; }
        ...
        public UnitPrefix(IUnitPrefixTable someUnitPrefixTable, String someName, String somePrefixChars, IUnitPrefixExponent somePrefixExponent)
            : base(someName)
        {
            this.unitPrefixTable = someUnitPrefixTable;
            this.PrefixChar = somePrefixChars[0];
            this.SecondPrefixChar = somePrefixChars[1];
    ...
    public class UnitPrefixTable : IUnitPrefixTable
    {
        ...
        public char MapAlternativePrefixChar(Char somePrefixChar)
        {
            return somePrefixChar switch
            {                    // 'μ' // '\0x03BC' (char)956  
                                 // 'µ' // '\0x00B5' (char)181
                '\x03BC' => 'µ', // 'µ' MICRO SIGN  '\0x00B5' (char)181
                'k' => 'K',      // Kilo
                'h' => 'H',      // Hecto
                _ => somePrefixChar
            };
        ...
        public Boolean GetUnitPrefixFromPrefixString(String somePrefixChars, out IUnitPrefix unitPrefix)
        {
            /**
            somePrefixChar = MapToPrefixChar(somePrefixChar);
            **/

            foreach (UnitPrefix up in UnitPrefixes)
            {
                if (up.PrefixChar == somePrefixChars[0] && up.SecondPrefixChar == somePrefixChars[1])
                {
                    unitPrefix = up;
                    return true;
                }
        ...
        public IUnitPrefix UnitPrefixFromPrefixString(String somePrefixChars)
        {
            GetUnitPrefixFromPrefixString(somePrefixChars, out IUnitPrefix unitPrefix);
            return unitPrefix;
        }
    ...
    public abstract class Unit : ISystemItem, IUnit /* <BaseUnit | DerivedUnit | ConvertibleUnit | CombinedUnit> */
    {
        ...
        public virtual Unit Dimensionless => Global.dimensionless;
        ...
        public static Unit Parse(String unitString)
        {
            ...
            pu = ParseMixedUnit(ref unitString, ref resultLine, throwExceptionOnInvalidInput: true);
            return pu;
        }

        public static Unit ParseMixedUnit(ref String unitString, ref String resultLine, Boolean throwExceptionOnInvalidInput = true)
        {
            Unit pu = null;
                    ...
                    else
                    {
                        ...
                        else
                        {
                            ...
                            for (int unitLen = maxLen; unitLen > 0; unitLen--)
                            {
                                ...
                                if (su == null)
                                {
                                    su = Global.CurrentUnitSystems.ScaledUnitFromSymbol(unitStr);
                                }
                                **/
                                Unit su = Global.ScaledUnitFromSymbol(unitStr);
                                if (su != null)
                                {
        ...
        public virtual String ToPrintString()
        {
            ...
            else
            {
                IUnitSystem system = this.ExponentsSystem; // this.SimpleSystem;
                if ((system != null)
                    && (system != Global.CurrentUnitSystems.Default))
                {
                    unitStr = system.Name + "." + unitStr;
                }
            }
...
s = s + Amount.ToString(x, "#,##0.00 US|meter");            
        ...
        protected static Quantity CombineUnits(Unit u1, Unit u2, CombineExponentsFunc cef, CombineQuantitiesFunc cqf)
        {
            ...
            Debug.Assert(NoOfBaseUnits <= Global.PhysicsNoOfBaseUnits, "The 'NoOfBaseUnits' must be <= Global.PhysicsNoOfBaseQuanties");
    ...
    public class PrefixedUnitExponent : Unit, IPrefixedUnitExponent
    {
        ...
        public PrefixedUnitExponent CombinePrefixAndExponents(SByte outerPUE_PrefixExponent, SByte outerPUE_Exponent, out SByte scaleExponent, out Double scaleFactor)
        {
            ...
            Prefixes.PhysicsUnitPrefixes.GetFloorUnitPrefixAndScaleFactorFromExponent(combinedPrefixExponent, out IUnitPrefix combinedUnitPrefix, out SByte combinedScaleFactorExponent);

            IUnitPrefixExponent pe = new UnitPrefixExponent((SByte)(combinedPrefixExponent + this.prefixedUnit.Prefix.Exponent));

            if (Prefixes.PhysicsUnitPrefixes.GetUnitPrefixFromExponent(pe, out IUnitPrefix up))
            {
    ...
    public class PrefixedUnitExponentList : List<IPrefixedUnitExponent>, IPrefixedUnitExponentList
    {
        ...
        public IPrefixedUnitExponentList Power(SByte exponent)
        {
            ...
            foreach (IPrefixedUnitExponent pue in this)
            {
                ...
                {
                    Prefixes.PhysicsUnitPrefixes.GetFloorUnitPrefixAndScaleFactorFromExponent(newPrefixExponent, out newUnitPrefix, out SByte scaleFactorExponent);
                    if (scaleFactorExponent != 0)
                    {
    ...
    public class CombinedUnit : Unit, ICombinedUnit
    {
            ...
            foreach (IPrefixedUnitExponent pue in combinedUnit.Numerators)
            {
                ...
                if (!found )
                {
                    if (someFactorValue != 1)
                    {
                        ...
                        Prefixes.PhysicsUnitPrefixes.GetFloorUnitPrefixAndScaleFactorFromExponent(somePrefixExponent, out tempPrefix, out ScaleFactorExponent);
                    }
                    else
                    {   
        ...
        public override IUnitSystem ExponentsSystem
        {
            get
            {
                ...
                if (subUnitSystems != null)
                {
                    ...
                    {
                        IUnitSystem DefaultUnitSystem = Global.CurrentUnitSystems.Default;
        ...
        {
            return u1 != null &&  u1.Equals(SI.W) && u2 != null && u2.Equals(SI.h);
        }

        private void CombineFactorPUEL(IPrefixedUnitExponent prefixedUnitExponent, CombineExponentsFunc cef, bool shortenScaledUnits, bool shortenWellKnownScaledTimeUnits /* = false */, IPrefixedUnitExponentList inPuel, ref IPrefixedUnitExponentList outPuel1, ref IPrefixedUnitExponentList outPuel2, 
        ...
        {
            IPrefixedUnitExponent previous_ue = null;
            foreach (IPrefixedUnitExponent ue in inPuel)
            {
                ...
                if (!primaryUnitFound && prefixedUnitExponent.Unit != null && ue.Unit != null && (   ue.Unit.Equals(prefixedUnitExponent.Unit as Unit)
                                                                                                  || (   (   shortenScaledUnits 
                                                                                                          && (shortenWellKnownScaledTimeUnits || !IsWellKnownScaledTimeCombinedUnits(previous_ue?.Unit as Unit, ue.Unit as Unit /* , prefixedUnitExponent.Unit as Unit */ ))) 
                                                                                                      && ue.Unit.Equivalent(prefixedUnitExponent.Unit as Unit, out quotient ))))
                {
                    primaryUnitFound = true;
        ...
        public CombinedUnit CombineMultiply(IPrefixedUnitExponent prefixedUnitExponent, bool shortenScaledUnits, bool shortenWellKnownScaledTimeUnits = false)
        {
            Debug.Assert(prefixedUnitExponent != null);
            ...
            CombineFactorPUEL(prefixedUnitExponent, SByte_Sub, shortenScaledUnits, shortenWellKnownScaledTimeUnits, Denominators, ref tempDenominators, ref tempNumerators,
            ...
            CombineFactorPUEL(prefixedUnitExponent, SByte_Add, shortenScaledUnits, shortenWellKnownScaledTimeUnits, Numerators, ref tempNumerators, ref tempDenominators,
                  ref primaryUnitFound, ref pue_prefixExp, ref scalingPrefixExponent, ref scalingExponent, ref scalingFactor,
                  ref multPrefixExponent, ref multExponent, ref changedExponentSign);
            ...
            if (!primaryUnitFound || changedExponentSign)
            {
                ...
                {
                    Prefixes.PhysicsUnitPrefixes.GetFloorUnitPrefixAndScaleFactorFromExponent(multPrefixExponent, out unitPrefix, out restMultPrefixExponent);
        ...
        public CombinedUnit CombineDivide(IPrefixedUnitExponent prefixedUnitExponent, bool shortenScaledUnits, bool shortenWellKnownScaledTimeUnits)
        {
            Debug.Assert(prefixedUnitExponent != null);

            SByte newExponent = (SByte)(-prefixedUnitExponent.Exponent);
            IPrefixedUnitExponent temp_pue = new PrefixedUnitExponent(prefixedUnitExponent.Prefix, prefixedUnitExponent.Unit, newExponent);
            return this.CombineMultiply(temp_pue, shortenScaledUnits, shortenWellKnownScaledTimeUnits);
        }
        ...
        public CombinedUnit CombineMultiply(ICombinedUnit cu2, bool shortenScaledUnits = false, bool shortenWellKnownScaledTimeUnits = false)
        {
            ...
            {
                cu1 = cu1.CombineMultiply(pue, shortenScaledUnits, shortenWellKnownScaledTimeUnits);
            }

            foreach (IPrefixedUnitExponent pue in cu2.Denominators)
            {
                cu1 = cu1.CombineDivide(pue, shortenScaledUnits, shortenWellKnownScaledTimeUnits);
            }
    ...
    public abstract class AbstractUnitSystem : NamedItem, IUnitSystem
    {
        ...
        public virtual Boolean IsModifiableUnitSystem { get; } = false;
            ...
            : this(someName, someUnitPrefixes, isModifiableUnitSystem)
        {
            ...
            CheckBaseUnitsForSystem();

            int noOfBaseUnits = this.BaseUnits?.Length ?? 0;
            if (noOfBaseUnits > 0)
            {
        ...
        {
            if (this.GetType() == typeof(UnitSystem))
            {
                // SimpleSystem is readonly now; must be build for this system 
        ...
        protected void CheckBaseUnitsForSystem()
        {
            Debug.Assert(this.BaseUnits != null || this.IsModifiableUnitSystem);
        ...
        protected void CheckNamedDerivedUnitsForSystem()
        {
            if (this.NamedDerivedUnits != null)
            {
                foreach (NamedDerivedUnit namedDerivedunit in this.NamedDerivedUnits)
                {
                    ...
                    if (this.BaseUnits.Where(bu => bu.Name == namedDerivedunit.Name).Count() > 0)
                    {
                        Debug.Assert(this.BaseUnits.Where(bu => bu.Name == namedDerivedunit.Name).Count() == 0);
                    ...
                    if (this.BaseUnits.Where(bu => bu.Symbol == namedDerivedunit.Symbol).Count() > 0)
                    {
                        Debug.Assert(this.BaseUnits.Where(bu => bu.Symbol == namedDerivedunit.Symbol).Count() == 0);
        ...
        protected void CheckConvertibleUnitsForSystem()
        {
            if (this.ConvertibleUnits != null)
            {
                try
                {
                    foreach (ConvertibleUnit convertibleUnit in this.ConvertibleUnits)
                    {
                        ...
                        {
                            var matchingNameNamedBaseUnits = this.BaseUnits.Where(bu => bu.Name == convertibleUnit.Name && bu.SymbolOrName == convertibleUnit.SymbolOrName);
                            if (matchingNameNamedBaseUnits.Count() > 0)
                            {
                                Debug.Assert(matchingNameNamedBaseUnits.Count() == 0);

                                IList<String> baseUnitNumbers = matchingNameNamedBaseUnits.Select(bu2 => $"{bu2.BaseUnitNumber} ({bu2.Symbol})").ToList();
                        ...
                        {
                            var matchingSymbolNamedBaseUnits = this.BaseUnits.Where(bu => bu.SymbolOrName == convertibleUnit.SymbolOrName);
                            if (matchingSymbolNamedBaseUnits.Count() > 0)
                            {
                                Debug.Assert(matchingSymbolNamedBaseUnits.Count() == 0);

                                IList<String> baseUnitNumbers = matchingSymbolNamedBaseUnits.Select(bu2 => $"{bu2.BaseUnitNumber} ({bu2.Symbol})").ToList();
                                throw new ArgumentException($"A unit's Name must be unique for the unit system: {convertibleUnit.Name} is at base unit index {baseUnitNumbers.ToStringList()}", "someNamedDerivedUnits");
                            }
                        }
                        ...
                        {
                            var matchingNameNamedDerivedUnits = this.NamedDerivedUnits.Where(ncu => ncu.Name == convertibleUnit.Name && ncu.SymbolOrName == convertibleUnit.SymbolOrName);
                            if (matchingNameNamedDerivedUnits.Count() > 0)
                            {
                                Debug.Assert(matchingNameNamedDerivedUnits.Count() == 0);

                                IList<String> namedDerivedUnitNameAndSymbols = matchingNameNamedDerivedUnits.Select(ndu2 => $"{ndu2.Name} ({ndu2.Symbol})").ToList();
                                throw new ArgumentException($"A unit's Name must be unique for the unit system: {convertibleUnit.Name} is at DerivedUnit {namedDerivedUnitNameAndSymbols.ToStringList()}", "someConvertibleUnits");
                            }
                        }

                        if (NamedDerivedUnits != null)
                        {
                            var matchingSymbolNamedDerivedUnits = this.NamedDerivedUnits.Where(ncu => ncu.SymbolOrName == convertibleUnit.SymbolOrName);
                            if (matchingSymbolNamedDerivedUnits.Count() > 0)
                            {
                                Debug.Assert(matchingSymbolNamedDerivedUnits.Count() == 0);

                                IList<String> namedDerivedUnitNameAndSymbols = matchingSymbolNamedDerivedUnits.Select(ndu2 => $"{ndu2.Name} ({ndu2.Symbol})").ToList();
                                throw new ArgumentException($"A unit's Symbol must be unique for the unit system: {convertibleUnit.Symbol} is at DerivedUnit {namedDerivedUnitNameAndSymbols.ToStringList()}", "someConvertibleUnits");
                            }
                        }

                        if (ConvertibleUnits != null)
                        {
                            var matchingNameNamedConvertibleUnits = this.ConvertibleUnits.Where(ncu => ncu.Name == convertibleUnit.Name && ncu.SymbolOrName == convertibleUnit.SymbolOrName);
                            if (matchingNameNamedConvertibleUnits.Count() > 1)
                            {
                                Debug.Assert(matchingNameNamedConvertibleUnits.Count() == 1);

                                IList<String> namedConvertibleUnitNameAndSymbols = matchingNameNamedConvertibleUnits.Select(ncu2 => $"{ncu2.Name} ({ncu2.Symbol})").ToList();
                                throw new ArgumentException($"A unit's Name must be unique for the unit system: {convertibleUnit.Name} is at named ConvertibleUnit {namedConvertibleUnitNameAndSymbols.ToStringList()}", "someConvertibleUnits");
                            }
                        }

                        if (ConvertibleUnits != null)
                        {
                            var matchingSymbolNamedConvertibleUnits = this.ConvertibleUnits.Where(ncu => ncu.Symbol == convertibleUnit.Symbol);
                            if (matchingSymbolNamedConvertibleUnits.Count() > 1)
                            {
                                Debug.Assert(matchingSymbolNamedConvertibleUnits.Count() == 1);

                                IList<String> namedConvertibleUnitNameAndSymbols = matchingSymbolNamedConvertibleUnits.Select(ncu2 => $"{ncu2.Name} ({ncu2.Symbol})").ToList();
                                throw new ArgumentException($"A unit's Symbol must be unique for the unit system: {convertibleUnit.Name} is at named ConvertibleUnit {namedConvertibleUnitNameAndSymbols.ToStringList()}", "someConvertibleUnits");
                            }
                        }
                    }
                }
    ...
    **/
    ...
    {
         public UnitSystem(String someName, Boolean someIsIsolated, Boolean isModifiableUnitSystem = false)
            : base(someName, someIsIsolated, isModifiableUnitSystem)
        {
        ...
        public UnitSystem(String someName, UnitPrefixTable someUnitPrefixes, Boolean isModifiableUnitSystem = false)
            : base(someName, someUnitPrefixes, isModifiableUnitSystem)
        {
        }

        public UnitSystem(String someName, UnitPrefixTable someUnitPrefixes, BaseUnitsBuilderFunction someBaseUnitsBuilder, Boolean isModifiableUnitSystem = false)
            : base(someName, someUnitPrefixes, someBaseUnitsBuilder, isModifiableUnitSystem)
        {
        }

        public UnitSystem(String someName, UnitPrefixTable someUnitPrefixes, BaseUnitsBuilderFunction someBaseUnitsBuilder, NamedDerivedUnitsBuilderFunction someNamedDerivedUnitsBuilder, Boolean isModifiableUnitSystem = false)
            : base(someName, someUnitPrefixes, someBaseUnitsBuilder, someNamedDerivedUnitsBuilder, isModifiableUnitSystem)
        {
        }
        ...
        public UnitSystem(String someName, UnitPrefixTable someUnitPrefixes, BaseUnit someBaseUnit, NamedDerivedUnitsBuilderFunction someNamedDerivedUnitsBuilder, ConvertibleUnitsBuilderFunction someConvertibleUnitsBuilder, Boolean isModifiableUnitSystem = false)
            : this(someName, someUnitPrefixes, (unitsystem) =>  new BaseUnit[] { someBaseUnit }, someNamedDerivedUnitsBuilder, someConvertibleUnitsBuilder, isModifiableUnitSystem)
        {
        }
    }

    public class ExtentedUnitSystem : AbstractUnitSystem
    {
             ...
             : base(someUnitSystemName, someUnitPrefixes: extentionOfUnitSystem.UnitPrefixes
                 , someBaseUnitsBuilder:
                      (unitSystem) =>
                      {
                          ...
                          {
                              return oldClonedBaseUnits.ToArray();
                          }
                          var extraBaseUnits = someExtraBaseUnitsBuilder(unitSystem);
                          return oldClonedBaseUnits.Concat(extraBaseUnits).ToArray();
                      }
                 , someNamedDerivedUnitsBuilder:
                    (unitSystem) =>
                    {
                        ...
                        {
                            return oldClonedNamedDerivedUnits.ToArray();
                        }
                        var extraNamedDerivedUnits = someExtraNamedDerivedUnitsBuilder(unitSystem);
                        return oldClonedNamedDerivedUnits.Concat(extraNamedDerivedUnits).ToArray();
                    }
                 , someConvertibleUnitsBuilder:
                    (unitSystem) =>
                    {
                        ...
                        {
                            return oldClonedConvertibleUnits.ToArray();
                        }
    ...
    public class CombinedUnitSystem : AbstractUnitSystem, ICombinedUnitSystem
    {
        ...
        public CombinedUnitSystem(String someName, IUnitSystem[] someSubUnitSystems)
            ...
            : base(someName ?? "<" + someSubUnitSystems.Select(us => us.Name).ToStringList() + ">"
                   , new UnitPrefixTable(someSubUnitSystems.Where(us => !(us.UnitPrefixes is null)).SelectMany(us => us.UnitPrefixes?.UnitPrefixes)
                                                           .Distinct().ToArray())
                   , /* BaseUnits */ (aus => someSubUnitSystems.Where(us => !(us.BaseUnits is null)).Select(us => us.BaseUnits)
                                               .Aggregate((buslist, bus) => ArrayExtensions.Concat<BaseUnit>(buslist, bus)))
                   , /* NamedDerivedUnits */ (aus => someSubUnitSystems.Where(us => !(us.NamedDerivedUnits is null)).Select(us => us.NamedDerivedUnits)
                                               .Aggregate((nduslist, ndus) => UnitArrayExtensions.UnionUniqueName<NamedDerivedUnit>(nduslist, ndus)))
                   , /* ConvertibleUnits */ (aus => someSubUnitSystems.Where(us => !(us.ConvertibleUnits is null)).Select(us => us.ConvertibleUnits)
                                               .Aggregate((cuslist, cus) => UnitArrayExtensions.UnionUniqueName<ConvertibleUnit>(cuslist, cus)))  )
        {
        ...
        public static class UnitArrayExtensions
        {
            public static T[] UnionUniqueName<T>(T[] a1, T[] a2) where T : Unit, INamedUnit
            {
                if (a1 != null && a2 != null)
                {   
                    var a2Unique = a2.Where(u2 => !a1.Any(u1 => u1.UnitName == u2.UnitName)).ToArray();
                    return a1.Concat(a2Unique).ToArray();
                }
            ...
            public static T[] UnionUniqueNameAndDefinition<T>(T[] a1, T[] a2) where T : Unit, INamedUnit
            {
                if (a1 != null && a2 != null)
                {
                    var a2Unique = a2.Where(u2 => !a1.Any(u1 => u1.UnitName == u2.UnitName /*** && u1.UnitDefinition == u2.UnitDefinition ***/ && u1.UnitSymbol == u2.UnitSymbol )).ToArray();
                    return a1.Concat(a2Unique).ToArray();
                }
        ...
        {
            // SimpleSystem is readonly now; must be build for this system unless UnitSystems will first be set later 
            Debug.Assert(UnitSystems == null || UnitSystems.Contains(aSystemUnit.SimpleSystem));
        }

        protected override void CheckUnitsSystem(ConvertibleUnit convertibleUnit)
        {
            // SimpleSystem is readonly now; must be build for this system unless UnitSystems will first be set later 
            Debug.Assert(UnitSystems == null || UnitSystems.Contains(convertibleUnit.SimpleSystem));
            Debug.Assert(UnitSystems == null || UnitSystems.Contains(convertibleUnit.PrimaryUnit.SimpleSystem));
        }
    ...
    public class Quantity : IQuantity
    {
        ...
        public Quantity(Double someValue)
            : this(someValue, Global.dimensionless)
        {
        }
        ...
        public Quantity(Double someValue, Unit someUnit)
        {
            ...
            this.Unit = someUnit ?? Global.dimensionless;
        }
        ...
        public Quantity(Quantity somePhysicalQuantity)
        {
            ...
            {
                this.Value = 0;
                this.Unit = Global.dimensionless;
            }
        }
        ...
        public Quantity ConvertTo(Unit convertToUnit)
        {
            ...
            if (convertToUnitsystem == null)
            {
                Debug.WriteLine("convertToUnitsystem assigned from Physics.CurrentUnitSystems.Default");
                convertToUnitsystem = Global.CurrentUnitSystems.Default;
            }
        ...
        protected static Quantity CombineUnitsAndValues(IQuantity pq1, IQuantity pq2, CombineValuesFunc cvf, CombineExponentsFunc cef)
        {
            ...
            Debug.Assert(maxNoOfBaseUnits <= Global.PhysicsNoOfBaseUnits);

            SByte[] someExponents = new SByte[Global.PhysicsNoOfBaseUnits];
        ...
        public Quantity Power(SByte exponent)
        {
            ...
            if (pu == null)
            {
                pu = Global.CurrentUnitSystems.Default.Dimensionless;
            }
    ...
    ***/
    ...
    public class UnitSystemConversionLookup
    {
        ...
        public UnitSystemConversion GetIntermediateUnitSystemConversion(IList<UnitSystemConversion> unitSystemConversions,
                                                                        IList<IUnitSystem> oldUnitSystems1, IList<IUnitSystem> newUnitSystemsConvertibleToUnitSystems1,
                                                                        IList<IUnitSystem> oldUnitSystems2, IList<IUnitSystem> newUnitSystemsConvertibleToUnitSystems2)
        {
            IList<IUnitSystem> unitSystemsConvertibleToUnitSystems1 = new List<IUnitSystem>();
            IList<IUnitSystem> unitSystemsConvertibleToUnitSystems2 = new List<IUnitSystem>();
            ...
            foreach (UnitSystemConversion usc in UnitSystemConversions)
            {
                Boolean BUS_in_US1 = newUnitSystemsConvertibleToUnitSystems1.Contains(usc.BaseUnitSystem);
                Boolean CUS_in_US1 = newUnitSystemsConvertibleToUnitSystems1.Contains(usc.ConvertedUnitSystem);

                Boolean BUS_in_US2 = newUnitSystemsConvertibleToUnitSystems2.Contains(usc.BaseUnitSystem);
                Boolean CUS_in_US2 = newUnitSystemsConvertibleToUnitSystems2.Contains(usc.ConvertedUnitSystem);
                ...
                if (BUS_in_US1 || CUS_in_US1)
                {
                    ...
                    if (!(BUS_in_US1 && CUS_in_US1))
                    {
                        if (BUS_in_US1)
                        {
                            unitSystemsConvertibleToUnitSystems1.Add(usc.ConvertedUnitSystem);
                        }
                        else
                        {
                            unitSystemsConvertibleToUnitSystems1.Add(usc.BaseUnitSystem);
                        }
                    }
                }
                else if (BUS_in_US2 || CUS_in_US2)
                {
                    ...
                    if (!(BUS_in_US2 && CUS_in_US2))
                    {
                        if (BUS_in_US2)
                        {
                            unitSystemsConvertibleToUnitSystems2.Add(usc.ConvertedUnitSystem);
                        }
                        else
                        {
                            unitSystemsConvertibleToUnitSystems2.Add(usc.BaseUnitSystem);
                        }
                    }
                }
            }
            ...
            if (unitSystemsConvertibleToUnitSystems1.Count > 0 || unitSystemsConvertibleToUnitSystems2.Count > 0)
            {
                IList<IUnitSystem> unitsystems1 = (IList<IUnitSystem>)oldUnitSystems1.Union(newUnitSystemsConvertibleToUnitSystems1).ToList();
                IList<IUnitSystem> unitsystems2 = (IList<IUnitSystem>)oldUnitSystems2.Union(newUnitSystemsConvertibleToUnitSystems2).ToList();

                UnitSystemConversion subIntermediereUnitSystemConversion = null;

                IList<IUnitSystem> intersectUnitsystemsList = unitSystemsConvertibleToUnitSystems1.Intersect(unitSystemsConvertibleToUnitSystems2).ToList();

                if (intersectUnitsystemsList.Count > 0)
                {
                    IUnitSystem intersectUnitsystem = intersectUnitsystemsList[0];
                    subIntermediereUnitSystemConversion = GetIntermediateUnitSystemConversion(unitsystems1Conversions, new List<IUnitSystem>() { }, newUnitSystemsConvertibleToUnitSystems1, new List<IUnitSystem>() { }, new List<IUnitSystem>() { intersectUnitsystem });
                ...
                else
                {
                    ...
                    {
                        subIntermediereUnitSystemConversion = GetIntermediateUnitSystemConversion(notIntermediereUnitSystemConversions, unitsystems1, unitSystemsConvertibleToUnitSystems1, unitsystems2, unitSystemsConvertibleToUnitSystems2);
                    }
                }
                if (subIntermediereUnitSystemConversion != null)
                {
                        ...
                        && !unitsystems1.Contains(subIntermediereUnitSystemConversion.ConvertedUnitSystem))
                    {
                        ...
                        Boolean secondValueConversionDirectionInverted = !unitSystemsConvertibleToUnitSystems1.Contains(subIntermediereUnitSystemConversion.BaseUnitSystem);
                        ...
                        {
                            Debug.Assert(unitSystemsConvertibleToUnitSystems1.Contains(subIntermediereUnitSystemConversion.ConvertedUnitSystem));
                        ...
                        && !unitsystems2.Contains(subIntermediereUnitSystemConversion.ConvertedUnitSystem))
                    {
                        ...
                        Boolean firstValueConversionDirectionInverted = !unitSystemsConvertibleToUnitSystems2.Contains(subIntermediereUnitSystemConversion.ConvertedUnitSystem);
                        ...
                        {
                            Debug.Assert(unitSystemsConvertibleToUnitSystems1.Contains(subIntermediereUnitSystemConversion.ConvertedUnitSystem) || unitsystems1.Contains(subIntermediereUnitSystemConversion.ConvertedUnitSystem));
